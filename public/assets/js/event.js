...
function getEvent() {
    fetch("/v1/events/".concat(eventId)).then(function(response) {
        ...
        document.querySelector("#eventPar h6").innerHTML = eventDateTime.toLocaleDateString('en-GB', dateOptions).concat(", ".concat(eventDateTime.toLocaleTimeString('en-GB', timeOptions)));
